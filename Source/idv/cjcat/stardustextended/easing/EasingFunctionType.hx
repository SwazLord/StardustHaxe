...
class EasingFunctionType {
	public static var functions(get, never):Map<Dynamic, Dynamic>;

	private static var _functions:Map<Dynamic, Dynamic>;

	private static function get_functions():Map<Dynamic, Dynamic> {
		if (_functions == null) {
			_functions = new Map<Dynamic, Dynamic>();
