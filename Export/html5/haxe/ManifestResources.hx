...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_blazing_fire_sde extends null { }
...
@:keep @:file("Assets/blazing_fire.sde") @:noCompletion #if display private #end class __ASSET__assets_blazing_fire_sde extends haxe.io.Bytes {}
